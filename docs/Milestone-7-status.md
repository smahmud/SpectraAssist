...
-   **Privacy Controls:**
    ...
    -   **Retention Policy:** Auto-deletes files older than N days (configurable 
    slider).
...
3.  **Auto-Cleanup:** Verified that the "Start Monitoring" logic respects 
sensitivity thresholds (silence) vs. "Capture Now" (force).

4.  **Purge:** Verified the "Purge All" button successfully deletes all content.

---

### Next Steps (Updated Plan: Milestone 7.5)

-   **Modularization:** Refactor the codebase into a clean MVVM structure.

-   **Testing:** Add unit tests for the Services.

-   **Objective:** Stabilize the technical foundation before moving to Milestone 8 (Final Polish).